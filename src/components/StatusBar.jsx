    ...
    <div style={{
      ...
      >
        <svg width="12" height="12" viewBox="0 0 14 14" fill="none" style={{ flexShrink: 0 }}>
          <circle cx="6" cy="6" r="4" stroke="rgba(0,0,0,0.4)" strokeWidth="1.3" />
          <path d="M10 10l3 3" stroke="rgba(0,0,0,0.4)" strokeWidth="1.3" strokeLinecap="round" />
        </svg>
        <input
          value={q}
