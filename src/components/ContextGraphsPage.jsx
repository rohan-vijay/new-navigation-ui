...
const GRAPHS = [
  { id: 'greif', name: 'Greif Operations Context Graph', version: 'v1.0.0', status: 'Live', nodes: 37, edges: 128, sources: 15, lastSync: 'Streaming', sharedType: 'org', shared: 'Everyone', owner: 'Marcus Feld', ownerInit: 'M', modified: 'Just now', isGreif: true },
  ...
  { id: 'finance', name: 'Finance Context Graph', version: 'v1.0.0', status: 'Live', nodes: 15, edges: 29, sources: 10, lastSync: '4 min ago', sharedType: 'org', shared: 'Everyone', owner: 'Grace Coleman', ownerInit: 'G', modified: 'Just now', isFinance: true },
