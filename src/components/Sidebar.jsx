...
const NAV = [
  ...
  { id:'ontology',   label:'AI Ontology & Data',  icon:'ontology',   children:['Unified Context Graph','Records','Data Pipelines','Data Catalog & Lineage','Data Quality','Ontology','Event Streams','Campaigns','Segments'] },
